...
sendManyBytesToSerial(serial_portBG431, createDATA_PACKET(setREG([MC_REG_CONTROL_MODE], [[MCM_SPEED_MODE]])))   # Set sin
...
plt.plot(elContAngle[inds]-elContAngle[inds[0]], contElAngleSpeedHz[inds]*60, '+-')
